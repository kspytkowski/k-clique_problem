...
public class Population {
     ...
     *
     * @param individualsAmount - amount of individuals that population should
     * have
     * @param kCliqueSize - size of k-clique
     */
     ...
     *
     * @param howMuchToRemove - shows how many individuals should be removed (in
     * percentage)
     */
